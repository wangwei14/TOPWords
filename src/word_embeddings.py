...
tauL = 5
tauF = 5
filename1 = 'chapter1.txt'
filename2 = 'story_of_stone.txt'

text = getText(filename2)
...
print(len(text))
vocabulary = splitor(text, dictionary)
...
def plot_with_labels(low_dim_embs, labels, myfont, filename='tsne.png'):
...
try:
    ...
    plot_with_labels(low_dim_embs, labels, myfont)
